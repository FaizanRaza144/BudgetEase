document.addEventListener("DOMContentLoaded", function () {
    ...
    categoryForm.addEventListener("submit", async function (event) {
        ...
        try {
            const response = await fetch("http://3.25.202.196/addcategories", {
                method: "POST",
                headers: {
    ...
    editCategoryForm.addEventListener("submit", async function (event) {
        ...
        try {
            const response = await fetch(`http://3.25.202.196/updateCategories/${id}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
    ...
    async function deleteCategory(event) {
        ...
        try {
            const response = await fetch(`http://3.25.202.196/delCategories/${id}`, {
                method: "DELETE",
                headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
            });
